...
def depthFirstSearch(problem):
    ...
    while not fringes.isEmpty():
        ...
        for nextState, nextAction, nextCost in successors:
            node = (nextState, actions + [nextAction])
            fringes.push(node)
...
def uniformCostSearch(problem):
    ...
    while not fringes.isEmpty():
        ...
        for nextState, nextAction, cost in successors:
            ...
            node = (nextState, newActions)
            fringes.push(node, totalCost)
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    # f = g + h
    fringes.push(node, 0 + heuristic(start, problem))
